...
const AllUsers = () => {
    ...
    const handleMakeAdmin = (user) => {
        fetch(`https://summer-camp-school-server-side-sable.vercel.app/users/admin/${user._id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleMakeInstructor = (user) => {
        fetch(`https://summer-camp-school-server-side-sable.vercel.app/users/instructor/${user._id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
